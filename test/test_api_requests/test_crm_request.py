...
from api_requests.crm.crm_requests import get_products, get_customers, get_customer_details, get_product_details
...
class MyTestCase(unittest.TestCase):
    ...
    def test_product_id_3(self):
        with open('response_files/product.json') as s:
            r = json.load(s)
